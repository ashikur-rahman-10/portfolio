...
const Skills = () => {
  ...
  return (
    <div className="px-4 md:px-10 w-full pt-10 md:pt-0 pb-10">
      <SectionTitle title={"My skills"}></SectionTitle>
      <div className="w-full min-h-[70vh] flex justify-center items-center">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 w-full md:gap-8 gap-3">
          {skills.map((skill, index) => (
            ...
            >
              <div className="flex flex-col items-center">
                <img className="w-12 mb-3" src={skill.icon} alt="" />
