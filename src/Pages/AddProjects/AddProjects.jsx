        ...
        <div className="px-10 w-full min-h-screen pt-10 md:pt-0 pb-10">
            ...
            <div className="w-fit mx-auto">
                <form
                    ...
                    className="space-y-4 p-4 lg:p-10 shadow-2xl rounded-2xl"
                >
                    <h1 className="text-center text-2xl md:text-4xl py-5 md:mb-4">
                        Add Your Project
                    </h1>
                    <div className="flex w-full flex-col lg:flex-row gap-4 lg:gap-10 ">
                        <div className="form-control">
                            ...
                            <input
                                ...
                                className="input input-bordered input-primary w-full lg:w-96 max-w-md"
                            />
                        </div>
                        <div className="form-control">
                            <label className="label">
                    ...
                    <div className="flex w-full flex-col lg:flex-row gap-4 lg:gap-10 ">
                        <div className="form-control">
                            ...
                            <input
                                ...
                                className="file-input file-input-bordered w-full lg:w-96 max-w-md"
                            />
                        </div>
                        <div>
                            <label className="label">
                    ...
                    <div className="flex w-full flex-col lg:flex-row gap-4 lg:gap-10 ">
                        <div className="form-control">
                            ...
                            <textarea
                                ...
                                className="textarea textarea-bordered textarea-primary w-full lg:w-96 max-w-md"
                            />
                        </div>
                        <div className="form-control">
                            <label className="label">
